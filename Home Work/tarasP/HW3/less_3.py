...
menu_congig = {
    "menu1": {
            ...
            '2':'2.Знайти в заданій стрічці кількість входжень слів (better, never, is)',
            '3':'3.Вивести весь текст у верхньому регістрі (всі великі літери)',
            '4':'4.Замінити всі входження символу “і” на “&”',
            '5':'5.Вихід',
    },
    "menu2": {
            '1':'1. better', 
...
def ReplaceLetter():
    replaseI = string.replace("i", "&")     #Зробити ,вибір символу який замінити, і символ на який замінити, і меню для цього вибору
    print(replaseI)

def MenuInput():
    print(menu_congig['menu1'])             # переробити виклик меню більш юзабельно, не в одній стрічці
